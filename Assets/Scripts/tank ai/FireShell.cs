...
public class FireShell : MonoBehaviour
{
    ...
    public float maxProjectileSpeed = 20f; // Maksymalna prêdkoœæ pocisku
    public float minDistance = 10f; // Minimalna odleg³oœæ od gracza, przy której AI nie strzela, tylko pod¹¿a za nim
    ...
    void Update()
    {
        ...
        float timeToHit = distanceToPlayer / maxProjectileSpeed;
        float? angle = RotateTurret();

        // AI strzela, gdy jest w stanie obliczyæ k¹t i czas opóŸnienia strza³u up³yn¹³
        ...
        // Skróæ dystans, jeœli AI nie ma szansy trafiæ gracza lub odleg³oœæ jest za du¿a
        if (distanceToPlayer > minDistance && angle == null)
        {
